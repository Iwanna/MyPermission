package com.trip.iwannafree.mypermission;
...
import com.trip.iwannafree.permission.HiPermission;
import com.trip.iwannafree.permission.PermissionCallback;
import com.trip.iwannafree.permission.PermissionItem;
...
//                        .style(R.style.CusStyle)
            ...
            case R.id.btn4:
                ...
                PermissionItem item = new PermissionItem(Manifest.permission.CAMERA, "相机", R.drawable.permission_ic_camera);
                HiPermission.create(MainActivity.this).checkSinglePermission(item, new PermissionCallback() {
                    @Override
                    public void onClose() {
                ...
                break;
            case R.id.btn5:
                item = new PermissionItem(Manifest.permission.ACCESS_FINE_LOCATION, "位置服务", R.drawable.permission_ic_location);
                //item = new PermissionItem(Manifest.permission.CAMERA, "相机", R.drawable.permission_ic_camera);
                HiPermission.create(MainActivity.this).checkSpecialSinglePermission(item,"Location", new PermissionCallback() {
                    @Override
                    public void onClose() {
