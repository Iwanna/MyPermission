...
public class PermissionActivity extends AppCompatActivity {
    ...
    public static int PERMISSION_TYPE_SPECIAL_SINGLE = 3;
    ...
    private static final int VIEW_SETTING = 100;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        } else if (mPermissionType == PERMISSION_TYPE_MUTI) {
            //多个权限
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(mSetting)) {
                    ...
                    if (android.os.Build.VERSION.SDK_INT > 10) {
                        ...
                        new ComponentName("com.android,settings", "com.android.settings.LocationSettings");
                        intent.setComponent(component);
                        intent.setAction("android.intent.action.VIEW");
                    }
                    startActivityForResult(intent, VIEW_SETTING);
                }
            }
        });
    ...
    private void getDatas() {
        ...
        mSetting = intent.getStringExtra("Setting");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        } else if (requestCode == VIEW_SETTING) {
            onFinish();
        }
    }
